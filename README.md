...
Parliamentary Debates - British parliamentary style with points of information

Lincoln-Douglas - One-on-one value-based philosophical debates
...
AI Judge - Impartial scoring and detailed feedback with rubric-based evaluation
...
Real-time Streaming - Watch debates unfold character by character

Memory & Analytics - Comprehensive debate logging and analysis
...
WebSocket Support - Real-time streaming and events

📊 Advanced Features
Cost Tracking - Monitor API usage and expenses (for paid providers)

Debate Summarization - AI-generated summaries and transcripts

Performance Analytics - Detailed metrics and improvement suggestions

Export Options - JSON, text, and CSV export formats
